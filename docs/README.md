...
- Simulated data set with commands
  1. sherman_cr_0.fastq (./Sherman -l 95 -n 100000 -e 0 --genome_folder ./genomeref/ -cr 0)
  2. sherman_cr_100.fastq (./Sherman -l 95 -n 100000 -e 0 --genome_folder ./genomeref/ -cr 100)
  3. sherman_cr_100_e_3.5.fastq (./Sherman -l 95 -n 100000 -e 3.5 --genome_folder ./genomeref/ -cr 100)
  4. art_simulation_cr_100.fastq
